...
if __name__ == "__main__":
    absa_examples = read_absa_data("/content/drive/MyDrive/Project_HK1_2022/NLP/Code/ViSA/datasets/UIT-ViSD4SA", '', '')
    for example in absa_examples:
        print(example.__dict__)
    print(read_visd4sa_data("/content/drive/MyDrive/Project_HK1_2022/NLP/Code/ViSA/datasets/UIT-ViSD4SA/train.jsonl",
                       '', '')[0].__dict__)
