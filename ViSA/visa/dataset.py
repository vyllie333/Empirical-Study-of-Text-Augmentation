...
from visa.processor import read_absa_data, read_visd4sa_data, convert_example_to_features, convert_example_to_features_with_offset, ABSAFeature
...
if __name__ == "__main__":
    ...
    build_dataset('/content/drive/MyDrive/Project_HK1_2022/NLP/Code/ViSA-master/datasets/samples', 
                  tokenizer, dtype='train', max_seq_len=128, device='cuda', overwrite_data=True)